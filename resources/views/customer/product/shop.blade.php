                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <div class="filter__sort d-flex align-items-center">
                                <span class="mr-1">Sort By</span> <!-- Add margin for spacing -->
                                <form action="{{ route('customer.shop') }}" method="GET">
                                    ...
                                    <select name="sort" onchange="this.form.submit()">
                                        ...
                                        <option value="price_asc"
                                            {{ request()->get('sort') === 'price_asc' ? 'selected' : '' }}>Harga Terendah
                                        </option>
                                        <option value="price_desc"
                                            {{ request()->get('sort') === 'price_desc' ? 'selected' : '' }}>Harga Tertinggi
                                        </option>
                                    </select>
                                </form>
                            </div>
